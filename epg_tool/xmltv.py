...
class xmltv:
    def __init__(self, channels=None, programs=None, df=None):
        self.channels = channels
        self.programs = programs
        self.df = df
    
    def parse_xml(self, location):
        self.channels = {}
        self.programs = []
        ...
        for ch in root.findall('channel'):
            ...
            self.channels[cur_channel.id] = cur_channel
        ...
        for p in root.findall('programme'):
            ...
            self.programs.append(cur_program)
